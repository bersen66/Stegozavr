...
find_path(bson_INCLUDE_DIRS_bson_bson_h
  NAMES bson/bson.h
  PATHS /usr/include/libbson-1.0 /usr/local/opt/mongo-c-driver/include/libbson-1.0
)
...
if (NOT bson_VERSION)
  ...
  if (UNIX AND NOT APPLE)
    ...
    pacman_version(bson_VERSION mongo-c-driver)
...
if (NOT TARGET bson)
  ...
  message(STATUS "bson include directories: ${bson_INCLUDE_DIRS}")
  target_link_libraries(bson INTERFACE ${bson_LIBRARIES})
  message(STATUS "bson libraries: ${bson_LIBRARIES}")
