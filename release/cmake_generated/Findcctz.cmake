...
if (NOT cctz_VERSION)
  ...
  if (UNIX AND NOT APPLE)
    ...
    pacman_version(cctz_VERSION cctz)
...
if (NOT TARGET cctz)
  ...
  message(STATUS "cctz include directories: ${cctz_INCLUDE_DIRS}")
  target_link_libraries(cctz INTERFACE ${cctz_LIBRARIES})
  message(STATUS "cctz libraries: ${cctz_LIBRARIES}")
