...
if (NOT GssApi_VERSION)
  include(DetectVersion)

  if (UNIX AND NOT APPLE)
    deb_version(GssApi_VERSION libkrb5-dev)
    
    pacman_version(GssApi_VERSION krb5)
...
if (NOT TARGET GssApi)
  ...
  message(STATUS "GssApi include directories: ${GssApi_INCLUDE_DIRS}")
  target_link_libraries(GssApi INTERFACE ${GssApi_LIBRARIES})
  message(STATUS "GssApi libraries: ${GssApi_LIBRARIES}")
