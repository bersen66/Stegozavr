...
if (NOT UserverGBench_VERSION)
  include(DetectVersion)

  if (UNIX AND NOT APPLE)
    deb_version(UserverGBench_VERSION libbenchmark-dev)
    rpm_version(UserverGBench_VERSION google-benchmark-devel)
    pacman_version(UserverGBench_VERSION benchmark)
    
  endif()
  if (APPLE)
    brew_version(UserverGBench_VERSION google-benchmark)
  endif()
  pkg_config_version(UserverGBench_VERSION benchmark)
endif()
...
if (NOT TARGET UserverGBench)
  ...
  message(STATUS "UserverGBench include directories: ${UserverGBench_INCLUDE_DIRS}")
  target_link_libraries(UserverGBench INTERFACE ${UserverGBench_LIBRARIES})
  message(STATUS "UserverGBench libraries: ${UserverGBench_LIBRARIES}")
