...
if (NOT TARGET mongoc-1.0)
  ...
  message(STATUS "mongoc-1.0 include directories: ${mongoc-1.0_INCLUDE_DIRS}")
  target_link_libraries(mongoc-1.0 INTERFACE ${mongoc-1.0_LIBRARIES})
  message(STATUS "mongoc-1.0 libraries: ${mongoc-1.0_LIBRARIES}")
