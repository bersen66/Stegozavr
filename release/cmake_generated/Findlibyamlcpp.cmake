...
if (NOT libyamlcpp_VERSION)
  include(DetectVersion)

  if (UNIX AND NOT APPLE)
    deb_version(libyamlcpp_VERSION libyaml-cpp-dev)
    
    pacman_version(libyamlcpp_VERSION yaml-cpp)
...
if (NOT TARGET libyamlcpp)
  ...
  message(STATUS "libyamlcpp include directories: ${libyamlcpp_INCLUDE_DIRS}")
  target_link_libraries(libyamlcpp INTERFACE ${libyamlcpp_LIBRARIES})
  message(STATUS "libyamlcpp libraries: ${libyamlcpp_LIBRARIES}")
